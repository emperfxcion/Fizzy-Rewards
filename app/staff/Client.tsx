...
// allow-list fallback (you + Tabitha)
...
export default function StaffClient() {
  ...
  const allow = useMemo(() => {
    ...
    const whitelisted = ALLOWLIST[email];
    return Boolean(whitelisted) || me?.role === 'staff' || me?.role === 'owner';
  }, [me, meEmail]);
  ...
  async function init() {
    ...
    // If allowlisted, ensure a profile & loyalty row exist (best effort; ignore if RLS blocks)
